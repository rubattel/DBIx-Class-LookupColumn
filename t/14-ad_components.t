...
use Test::DBIx::Class -config_path => [[qw/t etc schema /], [qw/t etc schema_ad_components schema_class/]], 'Actor', 'ActorRole', 'RoleType';


my $schema = Schema();


isa_ok Schema, 'Schema_ad_components'
  => 'Got Correct Schema';
...
my $result = 'Schema_ad_components';
